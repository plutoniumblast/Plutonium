...
function createScene () {
  ...
  camera = new THREE.PerspectiveCamera( 10, window.innerWidth / window.innerHeight, 0.5, 10000 );
  ...
  renderer.setClearColor( 0xffffff, 0.75 );
...
function createPixelData () {
  ...
  image.src = "./IMG_6706_copy-removebg-preview.png";
}
